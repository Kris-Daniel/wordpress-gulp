    ...
    jQuery(function ($) {
        ...
        $(document).on('click', '#gallery-metabox a.gallery-add', function (e) {
            ...
            file_frame.on('select', function () {
                ...
                selection.map(function (attachment, i) {
                    ...
                    var imgSrc = attachment.sizes.thumbnail ? attachment.sizes.thumbnail.url : attachment.sizes.full.url;

                    $('#gallery-metabox-list').append('<li><input type="hidden" name="vdw_gallery_id[' + index + ']" value="' + attachment.id + '"><img class="image-preview" src="' + imgSrc + '"><a class="change-image button button-small" href="#" data-uploader-title="Change image" data-uploader-button-text="Change image">Change image</a><br><small><a class="remove-image" href="#">Remove image</a></small></li>');
                });
            });
        ...
        $(document).on('click', '#gallery-metabox a.change-image', function (e) {
            ...
            file_frame.on('select', function () {
                ...
                that.parent().find('img.image-preview').attr('src', imgSrc);
            });
